    ...
    <!-- ======= Header ======= -->
		<header id="header" class="fixed-top">
			<div class="container d-flex align-items-center">
				...
				<a href="#in-why-choose-4" class="blue-btn position-relative" style="color:#fff;">
					Material <span class="d-none d-md-inline"> Kelas</span> 
...
class Footer extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = `
    <!-- ======= Footer ======= -->
    <footer id="footer" style="margin-top:-3px;">
  		<!-- ======= Footer-Top ======= -- >
